...
<YYINITIAL> {
        ...
        "function"                         { return new Symbol(SSimbolos.function, yycolumn, yyline, yytext()); }


        "{"                             { return new Symbol(SSimbolos.cor_open, yycolumn, yyline, yytext()); }
        "}"                             { return new Symbol(SSimbolos.cor_close, yycolumn, yyline, yytext()); }
	"->"				{ return new Symbol(SSimbolos.asig_right, yycolumn, yyline, yytext()); }
	"<-"				{ return new Symbol(SSimbolos.asig_left, yycolumn, yyline, yytext()); }
	","				{ return new Symbol(SSimbolos.coma, yycolumn, yyline, yytext()); }
	"\n"				{ return new Symbol(SSimbolos.salto, yycolumn, yyline, yytext()); }
